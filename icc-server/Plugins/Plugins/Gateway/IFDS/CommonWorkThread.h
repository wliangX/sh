...
public:	
	...
	void         AddMessage(CCommonThreadCore *pThreadCore = NULL, __culong_ uMsgId = 0, __culong_ ulParam = 0, __culong_ uwParam = 0, __clong_ lData = 0, std::shared_ptr<void> ptr = nullptr, std::string strmsg = "");
	bool         Start();
...
private:
	std::mutex					    m_mutexAddMsgVector;
	std::mutex					    m_mutexExecMsgVector;
