...
{
	CStatisticsTimerCore	   *pCoreTimer;	       //回调指针
...
{
public:	
	void AddTimer(CStatisticsTimerCore *pTimerCore, unsigned long uMsgId, unsigned long long uInterval);//uInterval,单位毫秒	  
