...
namespace ICC
{
	class CSwitchClientImpl :
		public ISwitchClient
	{
	public:
		CSwitchClientImpl(IResourceManagerPtr p_pResourceManager);
		virtual ~CSwitchClientImpl();
	...
	public:
		...
		virtual std::string GetReadyAgentEx(const std::string& strTarget) { return ""; };
		...
		//该接口只在Freeswitch AES组件实现
		virtual long FSAesAsyncRequestEx(const std::string p_strCmdName, const std::string& p_strResquestData) { return 0; };

		virtual long CreateConference(const std::string& p_strCompere, std::string& p_strConferenceId) { return 0; };
		virtual std::string QueryConferenceByCallid(const std::string& p_strCallRefId,std::string& p_strCompere, std::string& p_strBargeInSponsor) { return ""; };
		virtual long AddConferencePartyEx(const std::string& p_strCallRefId, const std::string& p_strTarget, const std::string& p_strTargetType, std::string& p_strConferenceId) { return 0; };
		virtual long AddConferenceParty(const std::string& p_strConferenceId, const std::string& p_strTarget, const std::string& p_strTargetType) { return 0; };

		virtual long DisenableConferenceParty(const std::string& p_strConferenceId, const std::string& p_strTarget, const std::string& p_strTargetType) { return 0; };
		virtual long DeleteConferenceParty(const std::string& p_strConferenceId, std::string& p_strTarget, const std::string& p_strTargetType) { return 0; };
		virtual long GetConferenceParty(const std::string& p_strConferenceId, std::string& p_strPartyData) { return 0; };

		virtual long GetHistoryCallList() { return 0; };
