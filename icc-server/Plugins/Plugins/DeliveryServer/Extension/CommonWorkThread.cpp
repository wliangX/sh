...
int CCommonWorkThread::AddMessage(CCommonThreadCore *pThreadCore /* = NULL */, __culong_ uMsgId /* = 0 */, __culong_ ulParam /* = 0 */, 
	...
	ICC::ObserverPattern::INotificationPtr pTask /* = nullptr */, ICC::PROTOCOL::IRequestPtr pRequest /* = nullptr */, ICC::PROTOCOL::IRespondPtr pRespond /* = nullptr */)
{
	try
	{		
		if (NULL != pThreadCore)
		{
			...
			msg_data.thread_data.pTask = pTask;		
			msg_data.thread_data.pRequest = pRequest;
			msg_data.thread_data.pRespond = pRespond;
