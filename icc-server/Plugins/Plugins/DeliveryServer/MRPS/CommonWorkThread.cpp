...
void CCommonWorkThread::AddMessage(CCommonThreadCore *pThreadCore /* = NULL */, __culong_ uMsgId /* = 0 */, __culong_ ulParam /* = 0 */, __culong_ uwParam /* = 0 */, __clong_ lData, std::string strmsg /* = "" */)
{
	try
	{		
		if (NULL != pThreadCore)
