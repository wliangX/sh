...
void CCommonWorkThread::AddMessage(CCommonThreadCore *pThreadCore /* = NULL */, __culong_ uMsgId /* = 0 */, __culong_ ulParam /* = 0 */,
	__culong_ uwParam /* = 0 */, __clong_ lData /* = 0 */, const std::string& strmsg /* = "" */, const std::string& strExt /* = "" */)
{
	try
	{		
		if (NULL != pThreadCore)
...
{
	m_iProcessCountBeforeNeedSleep = 100;
	m_bExitExec = false;
