            ...
            bool ParseString(std::string p_strJson, JsonParser::IJsonPtr p_pJson)
            {
                ...
                else
                {
                    for (int i = 0; i < p_pJson->GetCount("/body/dataList"); i++)
                    {
                        ...
                        l_CData.m_strIsVaild = p_pJson->GetNodeValue(l_strPath + l_strNum + "/isvalid", "");
                        l_CData.m_strImagePath = p_pJson->GetNodeValue(l_strPath + l_strNum + "/imagePath", "");
                        m_Body.m_vecData.push_back(l_CData);
                    }
                    return true;
                }
        ...
        public:
            ...
            public:
                ...
                public:
                    ...
                    std::string m_strOrgIdentifier;		std::string m_strXjType;
                    std::string m_strIsLeader;
                    std::string m_strIsVaild;           std::string m_strImagePath;
                };
