	...
	namespace PROTOCOL
	{
		...
		public:
			virtual bool ParseString(std::string p_strReq, JsonParser::IJsonPtr p_pJson)
			{
				...
				m_oBody.m_oProcess.m_strID = p_pJson->GetNodeValue("/body/alarm_process/id", "");
				m_oBody.m_oProcess.m_strAlarmID = p_pJson->GetNodeValue("/body/alarm_process/alarm_id", "");
				m_oBody.m_oProcess.m_strMsgSource = p_pJson->GetNodeValue("/body/alarm_process/msg_source", "");
			...
			virtual std::string ToString(JsonParser::IJsonPtr p_pJson)
			{
				...
				p_pJson->SetNodeValue(l_strPrefixPath + "msg_source", m_oBody.m_oProcess.m_strMsgSource);
